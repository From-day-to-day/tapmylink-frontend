...
export const HeaderLanguageSwitcher = () => {
  ...
  const onLanguageChange = (event: JSX.TargetedEvent<HTMLSelectElement, Event>) => {
    const selectedLanguage = (event.target as HTMLSelectElement).value as ELanguage;
  ...
  return (
    <div className={styles.menu}>
      <select className={styles.menu__select} value={currentLanguage} onChange={onLanguageChange}>
